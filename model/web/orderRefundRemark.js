...
exports.save = function(content, callback) {
    orderRefundRemark.build(content).save().then(function (result) {
...
exports.updateById = function(id, update, callback) {
    orderRefundRemark.update(update, {where: {id}}).then(function (result) {
        return callback(null, result);
    }).catch(function (err) {
        return callback(err);
    });
...
exports.findOneInfoById = function (id, callback) {
    orderRefundRemark.findOne({ where:{id} }).then(function (result) {
