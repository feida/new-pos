  ...
  <el-row style="height: 100%;">
    ...
    <el-col :span="7" class="left-wrapper" style="padding: 0;margin: 0;background-color: #fff;">
      <el-row type="flex" class="row-bg" justify="space-around" style="height: 50px">
        <el-col :span="9">
          <el-button  size="large" :class="tableOrder.distributionModeId == 1 ? 'base-btn-active' :'base-btn'"
                      @click="choiceMode(1)">堂食
          </el-button>
        </el-col>
        <el-col :span="9">
          <el-button  size="large" :class="tableOrder.distributionModeId == 3 ? 'base-btn-active' :'base-btn'"
      ...
      <div class="car-footer">
        ...
        <el-row style="text-align: center;" type="flex" justify="space-around" class="order-operate-button">
          <el-col :span="23" >
            ...
            <button class="operate-button operate-button-push-order" style="width: 100%" :loading="isCheckedOrder" @click="checkedOrder" >{{$t('order.checkedOrder')}}</button>
          </el-col>
        </el-row>
      </div>
    </el-col>
    ...
    <!--  右侧菜品信息   -->
    <el-col :span="17" class="right-wrapper" style="position: relative; padding-top: 50px">
      <order-toolbar  style="position: absolute; top:0; left: 0;" v-if="shopModel == 2 || shopModel == 7"></order-toolbar>
...
<script>
    ...
    import orderToolbar from '@/views/table/component/order-toolbar';
